var ymq_img_requirejs, ymq_img_require, ymq_img_define;
(function (global, setTimeout) {
    ...
    function makeError(id, msg, err, requireModules) {
        var e = new Error(msg + '\nhttps://ymq_img_requirejs.org/docs/errors.html#' + id);
        e.requireType = id;
    ...
    if (typeof ymq_img_define !== 'undefined') {
        //If a ymq_img_define is already in play via another AMD loader,
        //do not overwrite.
        return;
    }

    if (typeof ymq_img_requirejs !== 'undefined') {
        if (isFunction(ymq_img_requirejs)) {
            //Do not overwrite an existing ymq_img_requirejs instance.
            return;
        }
        cfg = ymq_img_requirejs;
        ymq_img_requirejs = undefined;
    }

    //Allow for a require config object
    if (typeof ymq_img_require !== 'undefined' && !isFunction(ymq_img_require)) {
        //assume it is a config object.
        cfg = ymq_img_require;
        ymq_img_require = undefined;
    }
    ...
    function newContext(contextName) {
        ...
        function hasPathFallback(id) {
            ...
            if (pathConfig && isArray(pathConfig) && pathConfig.length > 1) {
                ...
                //retry
                pathConfig.shift();
                context.ymq_img_require.undef(id);
         ...
         * This is true if this call is done for a ymq_img_define() module ID.
        ...
        handlers = {
            'ymq_img_require': function (mod) {
                if (mod.ymq_img_require) {
                    return mod.ymq_img_require;
                } else {
                    return (mod.ymq_img_require = context.makeRequire(mod.map));
                }
            },
        ...
        Module.prototype = {
            init: function (depMaps, factory, errback, options) {
                ...
                //are multiple ymq_img_define calls for the same module. That is not
            ...
            /**
             * Checks if the module is ready to ymq_img_define itself, and if so,
             * ymq_img_define it.
             */
            check: function () {
                ...
                if (!this.inited) {
                    ...
                    //ymq_img_define itself again. If already in the process
                    ...
                    if (this.depCount < 1 && !this.defined) {
                        if (isFunction(factory)) {
                            ...
                            //only do it for ymq_img_define()'d  modules. require
                            ...
                            if (err) {
                                ...
                                err.requireType = this.map.isDefine ? 'ymq_img_define' : 'ymq_img_require';
                    ...
                    //Finished the ymq_img_define stage. Allow calling check again
                    //to allow ymq_img_define notifications below in the case of a
                    //cycle.
                    this.defining = false;
            ...
            callPlugin: function () {
                ...
                on(pluginMap, 'defined', bind(this, function (plugin) {
                    ...
                    load.fromText = bind(this, function (text, textAlt) {
                        ...
                        //Turn off interactive script matching for IE for any ymq_img_define
        ...
        /**
         * Given an event from a script node, get the ymq_img_requirejs info from it,
        ...
        function intakeDefines() {
            ...
            while (defQueue.length) {
                args = defQueue.shift();
                if (args[0] === null) {
                    return onError(makeError('mismatch', 'Mismatched anonymous ymq_img_define() module: ' +
                        args[args.length - 1]));
                } else {
                    //args are id, deps, factory. Should be normalized by the
                    //ymq_img_define() function.
                    callGetModule(args);
                }
            }
            context.defQueueMap = {};
        ...
        context = {
            ...
            configure: function (cfg) {
                ...
                if (cfg.deps || cfg.callback) {
                    context.ymq_img_require(cfg.deps || [], cfg.callback);
                }
            },
            ...
            makeRequire: function (relMap, options) {
                ...
                function localRequire(deps, callback, errback) {
                    ...
                    if (options.enableBuildCallback && callback && isFunction(callback)) {
                        callback.__ymq_img_requirejsBuild = true;
                    }
                    ...
                    //Grab ymq_img_defines waiting in the global queue.
                    intakeDefines();

                    //Mark all the dependencies as needing to be loaded.
                    context.nextTick(function () {
                        //Some ymq_img_defines could have been added since the
                ...
                if (!relMap) {
                    localRequire.undef = function (id) {
                        //Bind any waiting ymq_img_define() calls to this context,
                        //fix for #408
                        takeGlobalQueue();
                        ...
                        //Clean queued ymq_img_defines too. Go backwards
            ...
            completeLoad: function (moduleName) {
                ...
                while (defQueue.length) {
                    ...
                    if (args[0] === null) {
                        ...
                        //Found matching ymq_img_define call for this script!
                        found = true;
                    }
                ...
                if (!found && !hasProp(defined, moduleName) && mod && !mod.inited) {
                    if (config.enforceDe11fine && (!shExports || !getGlobal(shExports))) {
                        if (hasPathFallback(moduleName)) {
                            return;
                        } else {
                            return onError(makeError('node11fine',
                                'No ymq_img_define call for ' + moduleName,
                                null,
                                [moduleName]));
                        }
                    } else {
                        //A script that does not call ymq_img_define(), so just simulate
                        //the call for it.
        ...
        context.ymq_img_require = context.makeRequire();
        return context;
    }
     ...
     */
    req = ymq_img_requirejs = function (deps, callback, errback, optional) {
        ...
        return context.ymq_img_require(deps, callback, errback);
    };
    ...
    each([
        ...
        req[prop] = function () {
            ...
            return ctx.ymq_img_require[prop].apply(ctx, arguments);
        };
    });
    ...
    req.load = function (context, moduleName, url) {
        ...
        if (isBrowser) {
            ...
            if (node.attachEvent &&
                ...
                //read https://github.com/ymq_img_requirejs/ymq_img_requirejs/issues/187
                //if we can NOT find [native code] then it must NOT natively supported.
                //in IE8, node.attachEvent does not have toString()
                //Note the test for "[native code" with no closing brace, see:
                //https://github.com/ymq_img_requirejs/ymq_img_requirejs/issues/273
                !(node.attachEvent.toString && node.attachEvent.toString().indexOf('[native code') < 0) &&
                !isOpera) {
                //Probably IE. IE (at least 6-8) do not fire
                //script onload right after executing the script, so
                //we cannot tie the anonymous ymq_img_define call to a name.
                //However, IE reports the script as being in 'interactive'
                //readyState at the time of the ymq_img_define call.
                useInteractive = true;
            ...
            //of the appendChild execution, so to tie an anonymous ymq_img_define
     ...
     * return a value to ymq_img_define the module corresponding to the first argument's
     * name.
     */
    ymq_img_define = function (name, deps, callback) {
        var node, context;
        ...
        if (!deps && isFunction(callback)) {
            ...
            if (callback.length) {
                ...
                //order listed below.
                deps = (callback.length === 1 ? ['ymq_img_require'] : ['ymq_img_require', 'exports', 'module']).concat(deps);
            }
        }

        //If in IE 6-8 and hit an anonymous ymq_img_define() call, do the interactive
        //work.
        if (useInteractive) {
...
ymq_img_require.config({
    baseUrl: 'https://www.luckydn.top/shop/',
    waitSeconds: 2000000,
    paths:{
        "jquery": 'jquery',
        "lightgallery": 'ymqfangda/js/lightgallery.min',
        "lg-zoom": "ymqfangda/js/lg-zoom.min",
        "lg-thumbnail": "ymqfangda/js/lg-thumbnail",
        "lg-video": "ymqfangda/js/lg-video.min",
        "swiper": "swiper/swiper-bundle",
        "zoom": "zoom/js/jquery.zoom"
    },
    shim: {
        'jquery' : {
            exports : 'ymqJQuery'
...
if (window.ymq_image.ymq_image_branding.extra.plan == 1){
    ymq_img_require(["jquery","lightgallery","lg-zoom","lg-thumbnail","lg-video","swiper","zoom"],function(ymqJQuery){

        ymqJQuery(function () {
            if(
                document.documentElement.innerHTML.match(/asyncLoad/) &&
                !document.documentElement.innerHTML.match(/SmBdBWwTCrjyN3AE/)
            ){
                return false;
            }
            function findMediaTopParent(e) {
                var i = ymqJQuery(e)
                    , n = i;
                for (; ; ) {
                    if (null == (i = (n = i).parent()).prop("tagName")){
                        return !1;
                    }
            ...
            if (ymq_image.imageParentDom) {
                ...
                ymq_image.imageParentDom.children().addClass('ymq_hide_tag').hide();
                try {
                    ...
                    var ymq_suoluetu_weizhi = 2;

                    //原来产品图展示的dom
                    var ymq_yuanlai_tupian_dom = ymq_image.imageParentDom;
                    ...
                    //轮播图包裹的元素width
                    var ymq_out_width = Number(ymq_yuanlai_tupian_dom.width());
                ...
                <ul id="ymq_lightgallery">
                    ...
                    function ymq_chuanjiandom(){
                        ...
                        if (ymq_suoluetu_weizhi == 2 || ymq_suoluetu_weizhi == 3) {
                            suoleutu_height = `style="height:${ymq_img_height}px"`;
                            is_chuizhi = 'vertical';
                        }
                        var html_big = `
                    <div class="ymq_product_img_big ymq_product_img_big${ymq_suoluetu_weizhi} ymq_swiper-container">
                        ...
                        <!-- Add Navigation -->
                        <div class="ymq_swiper-button-prev"><span class="ymq_iconfont">&#xe71f;</<span></div>
                        <div class="ymq_swiper-button-next"><span class="ymq_iconfont">&#xe71f;</<span></div>
                        <div class="ymq_swiper-pagination"></div>
                    </div>
            `
                        var html_small = `
                    <div ${suoleutu_height} class="ymq_product_img_small ymq_product_img_small${ymq_suoluetu_weizhi} ymq_swiper-container">
            ...
            `;
                        ...
                        ymq_yuanlai_tupian_dom.append(html_big+html_small);
                    ...
                    //获取可用图片
                    function ymq_xzkytp_zhu(now_bt){
                        //如果变体有图片
                ...
                `;
                    ...
                    if (!ymq_shubiaobianda) {
                        ymqJQuery('.ymq_zoom1 img').css('cursor','-webkit-grab')
                        ymqJQuery('.ymq_zoom1 img').css('cursor','grab')
                    }
                    //获取参数
                    ...
                    ymq_image.imageParentDom.find('.ymq_hide_tag').show();
                }
